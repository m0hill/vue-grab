    ...
    >
      ...
      >
        ...
        >
          ...
          <a
            href="cursor://anysphere.cursor-deeplink/prompt?text=These+are+the+installation+instructions+for+React+Grab.+Follow+the+instructions+to+install+%28based+on+the+framework+used+in+this+codebase%29%0A%0Ahttps%3A%2F%2Fraw.githubusercontent.com%2Faidenybai%2Freact-grab%2Frefs%2Fheads%2Fmain%2FREADME.md"
            target="_blank"
            rel="noopener noreferrer"
            style={{ textDecoration: "none", cursor: "pointer" }}
          >
